  ...
  return (
    <div className='flex flex-col gap-8 md:py-20 py-10 text-center w-full items-center px-4 md:px-8' id='aboutus'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1100px]'>
        ...
        <div className='col-span-1 md:col-span-2 bg-gradient-to-bl from-black via-gray-500 to-black overflow-hidden rounded-2xl  hover:shadow shadow-gray-500 duration-200'>
          <div className='p-6 md:p-10 max-w-full text-start space-y-4'>
            ...
            <Link href={'#menu'}>
              <button className='flex items-center gap-2 bg-gradient-to-r from-yellow-500 to-red-500 text-white outline-0 font-pt font-medium shadow-lg p-3 rounded-full cursor-pointer hover:scale-105 transition duration-300 font-pt text-sm md:text-base'>
