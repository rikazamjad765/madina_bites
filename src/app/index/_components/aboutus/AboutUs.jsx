  ...
  return (
    <div className='flex flex-col gap-8 md:py-20 py-10 text-center w-full items-center px-4 md:px-8'>
      <div className='flex flex-col gap-4 text-center w-full items-center'>
        <h1 className='font-love text-4xl md:text-6xl lg:text-7xl leading-tight text-gold'>Why Dine With Us?</h1>
        <p className='max-w-[900px] font-pt text-sm md:text-lg'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1000px]'>
        ...
        <div className='col-span-1 md:col-span-2 bg-white/50 rounded-2xl'>
          <div className='p-6 md:p-10 max-w-full text-start space-y-4'>
            ...
            <button className='flex items-center gap-2 bg-orange p-3 rounded-full cursor-pointer hover:scale-105 transition duration-300 font-pt text-sm md:text-base'>
